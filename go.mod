...
replace (
	...
	github.com/ChainSafe/chainbridge-eth-module v0.0.0-20210602125724-491a5ec01adb => ../chainbridge-eth-module
...
require (
	...
	github.com/ChainSafe/chainbridge-eth-module v0.0.0-20210602125724-491a5ec01adb
